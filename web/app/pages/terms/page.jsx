      ...
      <span className=" h-auto w-full">
        <div className="md:relative md:mt-auto mt-20">
          ...
          <div className="container mx-auto py-12 px-6 fontStyle shadow-md text-white">
            <h1 className="md:relative text-3xl font-bold mb-6 ">
            ...
            <div className="prose text-sm md:text-base lg:text-lg">
              <ol className="list-decimal pl-6 list-inside font-semibold text-xs md:relative">
                <li className="p-3">
                  By using the Spend Wise app, you agree to comply with the
                ...
                <li className="p-3">
                  Spend Wise may use cookies and tracking technologies to
                ...
                <li className="p-3">
                  Users are responsible for any fees associated with their
                  financial accounts linked to Spend Wise.
                </li>
                <li className="p-3">
                ...
                <li className="p-3">
                  Users may not reverse engineer, decompile, or disassemble the
                  app.
                </li>
                <li className="p-3">
                ...
                <li className="p-3">
                  Spend Wise may send notifications and updates to users through
                  the app.
                </li>
                <li className="p-3">
                  Users may not use the app for any unlawful purposes.
                </li>
                <li className="p-3">
                  Spend Wise may display third-party advertisements or links. We
                  are not responsible for the content of these third-party
                  sites.
                </li>
                <li className="p-3">
